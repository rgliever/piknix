...
(function() {
  $(function() {
    $('#all-posts').imagesLoaded(function() {
      $('#all-posts').masonry({
        itemSelector: '.box',
        isFitWidth: true,
        isAnimated: true
      ...
      $('.fancybox.in-gallery').mouseenter(function() {
        return $(this).siblings().stop().slideToggle(300);
      });
      $('.fancybox.in-gallery').mouseleave(function() {
        return $(this).siblings().stop().slideToggle(300);
      });
      $('.post-delete, #post-edit, #post-info').mouseenter(function() {
        return $(this).stop().show();
      });
      $('.post-delete, #post-edit, #post-info').mouseleave(function() {
        return $(this).stop().hide();
      });
      return $('a#post-form').fancybox({
        width: 400
      });
    });
    $('.fancybox-display a').hover(function() {
      return $(this).siblings('#post-info').stop().fadeIn(300);
    }, function() {
      return $(this).siblings('#post-info').stop().fadeOut(300);
    });
    $('#tag_cloud_button').click(function() {
      $('#tag_cloud_button').css('color', '#02dd78');
      return $('#tag_cloud_button').css('border-bottom', '2px solid #02dd78');
    });
    return $('.alert').fadeOut(10000);
  });
