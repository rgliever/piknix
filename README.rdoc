...
* Posts -- After users log in, they can submit a post which contains an image and description. Their image will show up on their user profile board as well as the public board.
